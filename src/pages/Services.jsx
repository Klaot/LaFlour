        ...
        <div>
            ...
            <div >
                ...
                <div>
                    ...
                    Наш салон рад вам помочь! Мы осуществляем доставку цветов по всей России и даже миру.</p>
                    ...
                    получена по предоставленным контактам.</p>
                ...
                <div>
                    ...
                    <p>Оригинальные свадебные букеты сделают свадьбу незабываемой
                    ...
                    <p>Украшения из живых цветов — самый популярный акцент европейской свадебной моды. 
                    ...
                    Наш салон предлагает услугу оформления машин живыми цветами(весенне-летний сезон). 
                    ...
                    <p>Свадьба — яркое и значимое событие. Всегда хочется, 
                        ...
                        интересное флористическое оформление свадьбы с использованием 
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <ul>
                                ...
                                <li>Возможность наличного и безналичного расчета за услуги.</li>
